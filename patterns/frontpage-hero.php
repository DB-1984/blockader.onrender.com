...
<div class="wp-block-group">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center front-hero" style="padding-right:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
...
<!-- wp:site-tagline {"className":"hero-tagline","textColor":"contrast","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}}} /-->
...
<!-- /wp:group -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<figure class="wp-block-image aligncenter size-full hero-image">
				<img 
					src="<?php echo esc_url( get_theme_file_uri( 'assets/images/TMaeM.jpg' ) ); ?>"
					alt=""
